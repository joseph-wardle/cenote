...
//! | Module    | Role |
//! |-----------|------|
//! | `gpu`     | Unsafe-Vulkan quarantine: device context, buffers, submits, pipelines, acceleration structures, window presentation. Code outside this module does not touch raw `vk` handles. |
