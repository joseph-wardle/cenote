    ...
    ChangeSet {
        ops: vec![
            ...
            Op::Material(Box::new(MaterialPatch {
                ...
                subsurface_weight: Some(0.75),
                subsurface_color: Some([0.85, 0.57, 0.42]),
                subsurface_radius: Some(0.01),
                subsurface_radius_scale: Some([1.0, 0.5, 0.25]),
                subsurface_scatter_anisotropy: Some(-0.3),
